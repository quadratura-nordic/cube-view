(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["cube-view"] = factory(require("vue"));
	else
		root["cube-view"] = factory(root["Vue"]);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules//.cache//vue-loader","cacheIdentifier":"0f87e5ee-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/CubeView.vue?vue&type=template&id=702246a2&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"stage",staticClass:"load stage"},[_c('canvas',{ref:"canvas",staticClass:"canvas",staticStyle:{"width":"100%","margin":"0","display":"block"},attrs:{"width":"1260px","height":"654px"}}),(!_vm.imagesLoaded)?_c('div',[_c('div',{staticClass:"loader"})]):_vm._e()])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/CubeView.vue?vue&type=template&id=702246a2&
...
// CONCATENATED MODULE: ./src/components/matrix.js
...
// CONCATENATED MODULE: ./src/components/CubeMap.js
...
function () {
  ...
  _createClass(CubeMap, [{
    ...
    value: function init(canvas, images) {
      ...
      /*bottom*/
      -size, -size, -size, size, -size, -size, -size, -size, size, size, -size, size];
      var texAr = [0, 0, 1, 0, 0, 1, 1, 1];
      var textPos = texAr.concat(texAr, texAr, texAr, texAr, texAr);
      ...
      var projectionMatrixLocation = gl.getUniformLocation(program, "u_pmatrix");
      var aspect = gl.canvas.width / gl.canvas.height;
      var zNear = 0.01;
      var zFar = 1;
      var projectionMatrix = this.m4.perspective(Math.PI / 3, aspect, zNear, zFar); //let angleInRadians = 1;
      //let c = Math.cos(angleInRadians);
      //let s = Math.sin(angleInRadians);

      var lookAtPos = [0, 0, -size / 2];
      var cameraPos = [0, 0, 0];
      var up = [0, 1, 0];
      var cameraMatrix = this.m4.inverse(this.m4.lookAt(cameraPos, lookAtPos, up));
      gl.uniformMatrix4fv(projectionMatrixLocation, false, this.m4.multiply(projectionMatrix, cameraMatrix));
      gl.clearColor(0, 0, 0, 0);
    }
  }, {
    key: "render",
    value: function render(rotY, rotX) {
      var gl = this.gl;
      ...
      var transformMatrix = this.m4.xRotation(degToRad(-rotX));
      ...
      gl.bindBuffer(gl.ARRAY_BUFFER, this.texPosBuffer);
      {
        var _size = 2; // 2 components per iteration
        ...
        gl.vertexAttribPointer(this.texAttributeLocation, _size, _type, _normalize, _stride, _offset);
      }

      for (var i = 0; i < this.textures.length; i++) {
        var unit = 5 + i; // Pick some texture unit
        ...
        var count = 4;
        gl.drawArrays(primitiveType, _offset2, count);
      }
    }
  }]);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/CubeView.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var CubeViewvue_type_script_lang_js_ = ({
  props: ['images'],
  data: function data() {
    return {
      imageCount: 6,
  ...
  methods: {
    setupPan: function setupPan() {
      ...
      var mc = new hammer_default.a.Manager(stage);
      var pan = new hammer_default.a.Pan();
      mc.add(pan);
      mc.on('panstart', function () {
        _this.rotate.start.Y = _this.rotate.Y;
        _this.rotate.start.X = _this.rotate.X;
      });
      mc.on('pan', function (e) {
        var multi = 100 / e.target.clientWidth;
        _this.rotate.Y = _this.rotate.start.Y + e.deltaX * multi;
        _this.rotate.X = _this.rotate.start.X + e.deltaY * multi;

        _this.cube.render(_this.rotate.compass.Y - _this.rotate.compassStart.Y + _this.rotate.Y, _this.rotate.compass.X - _this.rotate.compassStart.X + _this.rotate.X);
      });
    ...
    setupCompass: function setupCompass() {
      ...
      window.addEventListener("orientationchange", function () {
        ...
        if (screen && screen.orientation) {
          _this2.orientation = screen.orientation.angle;
        } else {
      ...
      window.addEventListener('deviceorientation', function (e) {
        ...
        if (Z < 0 && _this2.orientation !== 0) {
          _this2.rotate.compass.Y = Y;
        } else {
          _this2.rotate.compass.Y = 180 + Y;
        }

        if (_this2.orientation === 0) {
          _this2.rotate.compass.X = 2 * (X - 45);
        } else if (_this2.orientation === 270 || _this2.orientation === -90) {
          _this2.rotate.compass.X = 2 * (Z - 90);
        } else if (_this2.orientation === 90) {
          _this2.rotate.compass.X = 2 * (-Z - 90);
        }

        if (_this2.rotate.compassStart.X == null || _this2.rotate.compassStart.Y == null) {
          _this2.rotate.compassStart.X = _this2.rotate.compass.X;
          _this2.rotate.compassStart.Y = _this2.rotate.compass.Y;
        }

        if (_this2.imagesLoaded) {
          _this2.cube.render(_this2.rotate.compass.Y - _this2.rotate.compassStart.Y + _this2.rotate.Y, _this2.rotate.compass.X - _this2.rotate.compassStart.X + _this2.rotate.X);
        }
      });
    },
    reset: function reset() {
      ...
      if (this.$refs.canvas) {
        ...
        var loadImage = function loadImage(src, index) {
          var img = new Image();
          ...
          img.onload = function () {
            ...
            if (count === 6) {
              _this3.imagesLoaded = true;

              _this3.cube.init(_this3.$refs.canvas, images);

              _this3.cube.render(_this3.rotate.compass.Y - _this3.rotate.compassStart.Y + _this3.rotate.Y, _this3.rotate.compass.X - _this3.rotate.compassStart.X + _this3.rotate.X);
            }
          };
...
// CONCATENATED MODULE: ./src/components/CubeView.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_CubeViewvue_type_script_lang_js_ = (CubeViewvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./src/components/CubeView.vue
...
var component = normalizeComponent(
  components_CubeViewvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
component.options.__file = "CubeView.vue"
/* harmony default export */ var CubeView = (component.exports);
...
//# sourceMappingURL=cube-view.umd.js.map